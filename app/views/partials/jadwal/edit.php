                        ...
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("jadwal/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="MAPEL">Mapel <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input id="ctrl-MAPEL"  value="<?php  echo $data['MAPEL']; ?>" type="text" placeholder="Enter Mapel"  required="" name="MAPEL"  class="form-control " />
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-HARI" name="HARI"  placeholder="Pilih Hari"    class="custom-select" >
                                                        ...
                                                        <?php
                                                        $HARI_options = Menu :: $HARI;
                                                        $field_value = $data['HARI'];
                                                        if(!empty($HARI_options)){
                                                        foreach($HARI_options as $option){
                                                        $value = $option['value'];
                                                        $label = $option['label'];
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required=""  id="ctrl-DOSEN" name="DOSEN"  placeholder="Pilih Dosen"    class="custom-select" >
                                                            <option value="">Pilih Dosen</option>
                                                            <?php
                                                            $DOSEN_options = Menu :: $DOSEN;
                                                            $field_value = $data['DOSEN'];
